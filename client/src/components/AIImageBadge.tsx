...
export function AIImageBadge({ imageUrl, size = "sm" }: AIImageBadgeProps) {
  ...
  if (size === "md") {
    return (
      <div className="absolute top-3 left-3 flex items-center gap-1.5 bg-white/15 backdrop-blur-md border border-white/25 text-white rounded-full px-3 py-1.5 text-sm font-medium shadow-lg">
