                    ...
                    <Link href="/chat">
                      <Card className="p-4 hover-elevate cursor-pointer h-full">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">المساعد الصحي</p>
                            <p className="text-sm text-muted-foreground">اسأل عن أي استفسار صحي</p>
                          </div>
                        </div>
                      </Card>
                    </Link>
                    <Link href="/profile">
                      <Card className="p-4 hover-elevate cursor-pointer h-full">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">متتبع المؤشرات</p>
                            <p className="text-sm text-muted-foreground">تابع صحتك يومياً</p>
                          </div>
                        </div>
                      </Card>
                    </Link>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex gap-3 mb-6">
                    ...
                    />
                    <Button size="icon" disabled={!comment.trim()} data-testid="button-send-comment">
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p>كن أول من يعلق على هذا الخبر</p>
                  </div>
                </CardContent>
              </Card>
            </article>
